...
export class UibAssetDetails extends BaseHTMLElement {
  ...
  `</dt>` +
  `<dd>` +
  (escapeHtml(humanize(asset.fileType))) +
  `</dd>` +
  `</div>` +
  `<div>` +
  `<dt>` +
  ...
  `</dt>` +
  `<dd>` +
  (escapeHtml(humanize(asset.sourceType))) +
  `</dd>` +
  `</div>` +
  `<div>` +
  `<dt>` +
  ...
  `</dt>` +
  `<dd>` +
  (escapeHtml(humanize(asset.scope))) +
  `</dd>` +
  `</div>` +
  `<div>` +
  `<dt>` +
  ...
  `</dt>` +
  `<dd>` +
  (escapeHtml(humanize(asset.visibility))) +
  `</dd>` +
  `</div>` +
  `<div>` +
  `<dt>` +
  ...
  `</dt>` +
  `<dd>` +
  (escapeHtml(formatBytes(asset.fileSizeBytes))) +
  `</dd>` +
  `</div>` +
  `<div>` +
  `<dt>` +
  ...
  `<dd>` +
  `v` +
  (escapeHtml(asset.currentVersionNumber || 1)) +
  `</dd>` +
  `</div>` +
  `<div>` +
  `<dt>` +
  ...
  `</dt>` +
  `<dd>` +
  (escapeHtml(formatDate(asset.updatedAt || asset.lastUpdatedAt))) +
  `</dd>` +
  `</div>` +
  `<div>` +
  `<dt>` +
  ...
  `</dt>` +
  `<dd>` +
  (escapeHtml(asset.permissionSetKey)) +
  `</dd>` +
  `</div>` +
  `<div class="wide">` +
  `<dt>` +
  ...
  `</dt>` +
  `<dd>` +
  (escapeHtml(asset.description || 'No description')) +
  `</dd>` +
  `</div>` +
  `<div class="wide">` +
  `<dt>` +
  ...
  `</dt>` +
  `<dd>` +
  (maskedValue(asset, 'storagePath', asset.storagePath)) +
  `</dd>` +
  `</div>` +
  `</dl>` +
  `<div class="row">` +
  ...
  `<style>` +
  (baseAssetStyles) +
  ` .details { display: grid; gap: 1rem; padding: 1rem; } .tabs { display: flex; flex-wrap: wrap; gap: 0.45rem; } .tabs button { min-height: 2.1rem; padding: 0.4rem 0.65rem; font-size: 0.82rem; } .summary-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 0.6rem; margin: 0; } .summary-grid div { padding: 0.75rem; border: 1px solid var(--uib-assets-border); border-radius: 0.8rem; background: var(--uib-assets-surface-soft); } .summary-grid .wide { grid-column: 1 / -1; } dt { margin: 0 0 0.2rem; color: var(--uib-assets-muted); font-size: 0.76rem; font-weight: 850; text-transform: uppercase; letter-spacing: 0.04em; } dd { margin: 0; overflow-wrap: anywhere; } ` +
  `</style>` +

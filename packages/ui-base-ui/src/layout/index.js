...
class UibSurfaceBase extends UibLayoutBase {
  ...
  ` ` +
  (baseStyles) +
  `.uib-surface{display:block;border:1px solid var(--uib-color-border,#d9e2f0);border-radius:var(--uib-radius-lg,1rem);background:var(--uib-color-surface,#fff);box-shadow:var(--uib-shadow-sm,0 6px 18px rgba(10,31,68,.08));overflow:hidden}.uib-surface__header,.uib-surface__body,.uib-surface__footer{padding:var(--uib-space-4,1rem)}.uib-surface__header{border-bottom:1px solid var(--uib-color-border,#d9e2f0);font-weight:850}.uib-surface__footer{border-top:1px solid var(--uib-color-border,#d9e2f0);background:var(--uib-color-surface-soft,#f8fbff)} ` +
  `</style>` +
  `<section class="uib-surface uib-` +
  (this.surfaceName) +
  `" part="base" ` +
...
export class UibTabs extends UibLayoutBase {
  ...
  ` ` +
  (baseStyles) +
  `.uib-tabs{display:grid;gap:.75rem}.uib-tabs__list{display:flex;gap:.35rem;flex-wrap:wrap}.uib-tabs__tab{padding:.55rem .75rem;border:1px solid var(--uib-color-border,#d9e2f0);border-radius:var(--uib-radius-pill,999px);background:var(--uib-color-primary,#174a8b);color:var(--uib-color-primary-contrast,#fff);font-weight:850}.uib-tabs__panel{padding:1rem;border:1px solid var(--uib-color-border,#d9e2f0);border-radius:var(--uib-radius-lg,1rem);background:var(--uib-color-surface,#fff)} ` +
  `</style>` +
  `<div class="uib-tabs" part="base">` +
  `<div class="uib-tabs__list" part="tablist" role="tablist">` +
  `<span class="uib-tabs__tab" part="tab" role="tab" aria-selected="true">` +
  ` ` +
  (escapeHtml(this.label || 'Tab')) +
  ` ` +
  `</span>` +
  `</div>` +
  `<div class="uib-tabs__panel" part="panel" role="tabpanel">` +
  `<slot>` +
  `<div class="placeholder">` +
  ` uib-tabs is an experimental stub. Full tab-panel coordination will be implemented later. ` +
  `</div>` +
  `</slot>` +
  `</div>` +
  `</div>`

  ...
  render() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div class="bar">
        ...
        <div class="actions">
          <button type="button" data-analyze>Analyze</button>
          <button type="button" data-diff>Diff</button>
          <button type="button" data-revert ${dirty ? '' : 'disabled'}>Revert</button>
          <button type="button" class="primary" data-save ${dirty && !readonly ? '' : 'disabled'}>Save request</button>
        </div>
      </div>
    `;
    this.bind();

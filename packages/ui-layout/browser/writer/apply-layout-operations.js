...
export function applyLayoutOperationsToSource(sourceText        , operations                   , options               = {})              {
...
function applyEdits(sourceText        , edits              , warnings          )         {
...
function updateOpeningTag(openingTag        , operation                 )         {
...
function setClassList(openingTag        , update                                 )         {
...
function indexNodes(nodes              , parent                    = null, map = new Map                           ())                                 {
  for (const node of nodes) {
...
function closingTagStart(sourceText        , node            , range                                )                {
...
function insertAttribute(openingTag        , attribute        )         {
...
function escapeStaticText(value        , fileName         )         {

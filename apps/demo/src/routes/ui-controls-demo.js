...
export function renderUiControlsRoute(main) {
  main.innerHTML = `
    <section class="page-heading">
      ...
      <p>
        Use this route to test labels, help text, required behavior, disabled/readonly/invalid states, custom toggle labels, parent-set values, and callback events.
      </p>
    </section>
      ...
      <aside class="card controls">
        <div class="card-content">
          <div class="controls-header">
            ...
            <button class="secondary-button compact-control-button" type="button" data-reset-control-options>
              Reset
            </button>
          </div>
          <div class="form-grid">
          ...
          <details class="control-section" open>
            ...
            <pre id="uiControlsMarkup" class="code-block">
            </pre>
          </details>
        </div>
      </aside>
      <section class="controls-playground-stage">
          ...
          <article class="card controls-demo-card">
            <div class="card-content controls-demo-card__content">
              <div>
                ...
                <p class="muted">
                  This instance is driven by the parent controls on the left.
                </p>
              </div>
              <uib-toggle id="playgroundToggle" name="workflowApproved" label="Workflow approved" help="Use N/A when approval has not been reviewed." labels="N/A,Yes,No">
              </uib-toggle>
            </div>
          </article>
          <article class="card controls-demo-card">
            <div class="card-content controls-demo-card__content">
              <div>
                ...
                <p class="muted">
                  The same disabled/readonly/invalid settings are applied here.
                </p>
              </div>
              <uib-checkbox id="playgroundCheckbox" name="documentationComplete" label="Documentation complete" help="Checkbox values are true or false.">
              </uib-checkbox>
            </div>
          </article>
          <article class="card controls-demo-card">
            <div class="card-content controls-demo-card__content">
              ...
              <uib-toggle id="tourPublishedToggle" name="published" label="Published" help="Use N/A when publication status has not been decided.">
              </uib-toggle>
            </div>
          </article>
          <article class="card controls-demo-card">
            <div class="card-content controls-demo-card__content">
              <div>
                ...
                <p class="muted">
                  ...
                  is present, the toggle only allows
                  <code>
                    true
                  </code>
                  or
              ...
              <uib-toggle id="requiresEscortToggle" name="requiresEscort" label="Escort required" help="Required toggles have no N/A choice." required>
              </uib-toggle>
            </div>
          </article>
          <article class="card controls-demo-card">
            <div class="card-content controls-demo-card__content">
              <div>
                ...
                <p class="muted">
                  Labels can be overridden with a comma-delimited list.
                </p>
              </div>
              <uib-toggle id="customLabelToggle" name="accessibilityAvailable" label="Accessibility available" labels="Not set,Yes,No" help-mode="inline" help="Inline help is also supported.">
              </uib-toggle>
            </div>
          </article>
          <article class="card controls-demo-card">
            <div class="card-content controls-demo-card__content">
              <div>
                ...
                <p class="muted">
                  The checkbox value is always boolean. Default value is
                  <code>
                    false
                  </code>
                  .
              ...
              <div class="controls-checkbox-stack">
                <uib-checkbox id="photoConsentCheckbox" name="photoConsent" label="Photo consent received" help="Value is true only when checked.">
                </uib-checkbox>
                <uib-checkbox id="accessibleSeatingCheckbox" name="accessibleSeating" help="Slotted text can be used as the visible label.">
        ...
        <section class="card controls-event-card">
          <div class="card-content">
            ...
            <p class="muted">
              User changes emit a bubbling
              <code>
                change
              </code>
              event and a component-specific event. The event detail contains
              <code>
                name
              </code>
              ,
            ...
            <div class="button-row">
              <button class="primary-button" type="button" data-set-sample-values>
                Parent set sample values
              </button>
              <button class="secondary-button" type="button" data-reset-sample-values>
                Reset values
              </button>
            </div>
            <div id="uiControlsStatus" class="status-box">
              Change a toggle or checkbox to see event feedback here.
            </div>
            <pre id="uiControlsEventLog" class="code-block controls-event-log">
              {}
            </pre>
          </div>
        </section>
